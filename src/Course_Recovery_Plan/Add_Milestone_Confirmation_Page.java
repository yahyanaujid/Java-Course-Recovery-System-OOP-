...
public class Add_Milestone_Confirmation_Page extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Add_Milestone_Confirmation_Page.class.getName());

    // Declare variables
    private Add_Milestone_Page add_milestone_page;
    private User user;
    ...
    // Constructor
    public Add_Milestone_Confirmation_Page(Add_Milestone_Page add_milestone_page, User user, String failedComponent, String[] newWeeks, String[] newTasks, String studentID) {
        this.add_milestone_page = add_milestone_page;
        this.user = user;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("You are about to add this milestone.");
    ...
    // Method 1: Add the new milestone, notify student and go back to Recovery Plan Page
    private void yesClicked() {
        ...
        String subject = "New Milestone Added";
        // Set text message for the email body
        String textMessage = "Dear Student,\n\n"
                + "We would like to inform you that a new milestone has been added to the school system. Please log in at your earliest convenience to review the updated information.\n\n"
        ...
        add_milestone_page.setVisible(false);
    }
