...
public class Update_Recommendation_Confirmation_Page extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Update_Recommendation_Confirmation_Page.class.getName());

    // Declare variables
    private Update_Recommendation_Page update_recommendation_page;
    private User user;
    ...
    // Constructor
    public Update_Recommendation_Confirmation_Page(Update_Recommendation_Page update_recommendation_page, User user, String[] newRecommendation, String failedComponent, String studentID) {
        this.update_recommendation_page = update_recommendation_page;
        this.user = user;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("You are about to update this recommendation.");
    ...
    // Method 1: Update the new recommendation, notify student and go back to Recommendation Page
    private void yesClicked() {
        ...
        String subject = "Updated Recommendation Available for Review";
        // Set text message for the email body
        String textMessage = "Dear Student,\n\n"
                + "We would like to inform you that one of the recommendation text has been updated in the school system. Please log in at your earliest convenience to review the updated information.\n\n"
        ...
        update_recommendation_page.setVisible(false);
    }
