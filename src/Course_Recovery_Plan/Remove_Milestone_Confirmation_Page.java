...
public class Remove_Milestone_Confirmation_Page extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Remove_Milestone_Confirmation_Page.class.getName());

    // Declare variables
    private Remove_Milestone_Page remove_milestone_page;
    private User user;
    ...
    // Constructor
    public Remove_Milestone_Confirmation_Page(Remove_Milestone_Page remove_milestone_page, User user, String failedComponent, String[] newWeeks, String[] newTasks, String studentID) {
        this.remove_milestone_page = remove_milestone_page;
        this.user = user;
        this.failedComponent = failedComponent;
        this.newWeeks = newWeeks;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("You are about to remove this milestone.");
    ...
    // Method 1: Remove the new milestone, notify student and go back to Recovery Plan Page
    private void yesClicked() {
        // Call joinMilestone method to set all milestones into a single string
        ms.joinMilestone(failedComponent, newWeeks, newTasks);
        ...
        String subject = "Removal of Milestone";
        // Set text message for the email body
        String textMessage = "Dear Student,\n\n"
                + "We would like to inform you that one of the milestone has been removed from the school system. Please log in at your earliest convenience to review the updated information.\n\n"
        ...
        remove_milestone_page.setVisible(false);
    }
